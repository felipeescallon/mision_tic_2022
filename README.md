...
# Actualizaciones:
 ...
 - **Completada**: ciclo 3 (Software development - web: AGILE, .NET, Entity Framework, Blazor, Razor, C#, SQL Server, Azure Cloud, HTML, CSS, JavaScript) - **ver proyecto de referencia desplegado en la nube de Azure [aquí!](https://hospicasa.azurewebsites.net/)**
*(recuerde registrarse para interactuar con la lista de pacientes!)*
