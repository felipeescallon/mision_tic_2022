...
namespace HospiEnCasa.App.Persistencia
{
    ...
    public class RepositorioPaciente : IRepositorioPaciente
    {
        ...
        ////ESTE FUE AGREGADO POR MI
        IEnumerable<Paciente> IRepositorioPaciente.GetPacientesFemeninos()
        {
...
//https://cuidateplus.marca.com/bienestar/2020/05/27/oximetro-coronavirus-necesitas-173506.html
        public IEnumerable<Paciente> GetPacientesRiesgoCovid()
        {

            return _appContext.Pacientes
                                   .Where(p => p.SignosVitales.Any(s =>  TipoSigno.SaturacionOxigeno == s.Signo && s.Valor<90))
                                   .ToList();
        }
