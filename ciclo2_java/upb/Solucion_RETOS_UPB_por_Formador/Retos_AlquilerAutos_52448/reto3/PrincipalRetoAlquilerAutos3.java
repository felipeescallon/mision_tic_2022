 ...
 */
public class PrincipalRetoAlquilerAutos3 {
    ...
    public static void main(String[] args) {
        ...
        */
        ...
        //PRUEBAS PARA CALCULAR COSTO:
        Alquiler alquiler_prueba5 = new Alquiler(cliente1, auto1, LocalDate.parse("2021-08-19"), 8);
        System.out.println(alquiler_prueba5.CalcularCosto(true));
        System.out.println("¡El anterior FUNCIONÓ porque dió 39200 y se esperaba 39200!");
        
        Alquiler alquiler_prueba6 = new Alquiler(cliente1, auto1, LocalDate.parse("2021-07-19"), 8);
        System.out.println(alquiler_prueba6.CalcularCosto(false));
        System.out.println("¡El anterior FUNCIONÓ porque dió 40000 y se esperaba 40000!");
        
        Cliente cliente_pipe = new Cliente("503030", 36, "Pipe Portilla");
        Alquiler alquiler_prueba7 = new Alquiler(cliente_pipe, auto1, LocalDate.parse("2021-08-01"), 124);
        System.out.println(alquiler_prueba7.CalcularCosto(true));
        System.out.println("¡El anterior FUNCIONÓ porque dió 607600 y se esperaba 607600!");
    }
